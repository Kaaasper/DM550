public class section2 {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(downToOne(26));
    }
    ...
    // //Print multiples using for loops
    // //Task 1
    // public static void printMultiples(){
    // for (int i = 0; i <= 500; i++) {
    // if ( i % 7 == 0){
    ...
    // Support function for task 6, print character c, n times
    ...
    // Task 7 - Since it is "Up to n", should it not be "i < n" not "i <= n"?
