public class Section4 {
    ...
    /*
     * Computes the gdc of m and n using Euclides' algorithm. Assumes n, m > 0.
     */
    ...
    /*
     * Reverses a queue. Destroys the argument queue.
     */
    ...
    // /*
    // * Splits the elements of a list according to their relationship to n.
    // Destroys
    // * the original list.
    // */
    // public static DLList<Integer>[] compare(DLList<Integer> v, int n) {
    // if (v.isEmpty())
    // return (DLList<Integer>[]) new Object[] { new DLList<Integer>(), new
    // DLList<Integer>(),
    // new DLList<Integer>() };
    // else {
    // int top = v.get(0);
    ...
    // /*
    // * Sums all the elements in a binary tree.
    // */
    // public static double sum(BinaryTree<Double> t) {
    // return (t.isEmpty() ? 0 : t.root() + sum(t.left()) + sum(t.right()));
    // }

    // /*
    // * Counts the number of zeros in a binary tree.
    // */
    // public static int zeros(BinaryTree<Integer> t) {
    // if (t.isEmpty())
    // return 0;
    // else
    // return (((t.root() == 0) ? 0 : 1) + zeros(t.left()) + zeros(t.right()));
    // }

    // /*
    // * Counts the number of occurrences of e in t.
    // */
    // public stateic <T> int count(BinaryTree<T> t, T e) {
    // if (t.isEmpty())
    // return 0;
    // else
    // return (((t.root() == e) ? 0 : 1) + count(t.left(), e) + count(t.right(),
    // e));
    // }
